...
<body>
    ...
    <n:notify container = "${notificationContainer}" noteType = "alert-success"/>
    <n:notify container = "${errorContainer}" noteType = "alert-danger"/>
    <n:notify container = "${warningContainer}" noteType = "alert-warning"/>
